...
% f - function hande. Use f = @(arg_n)fun(agr_1, agr_2, agr_3, agr_4, ...);,
%                     where fun is the actual name of the function, arg_* - arguments
% L and H - low and high margins of the initial search window
% tol - tolerance or exit criteria: the routine exits once abs(H - L) >= tol
